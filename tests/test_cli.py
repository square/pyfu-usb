...
from pyfu.__main__ import cli, create_parser
...
def mock_list_devices() -> Generator[mock.Mock, None, None]:
    """Mock pyfu.__main__.list_devices"""
    with mock.patch("pyfu.__main__.list_devices") as mock_obj:
        yield mock_obj


@pytest.fixture()
def mock_download() -> Generator[mock.Mock, None, None]:
    """Mock pyfu.__main__.download"""
    with mock.patch("pyfu.__main__.download") as mock_obj:
        yield mock_obj
