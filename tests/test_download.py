...
from pyfu import download
from pyfu.descriptor import DfuDescriptor
from pyfu.dfu import _DFU_STATE_DFU_IDLE
from pyfu.dfuse import DFUSE_VERSION_NUMBER
...
def mock_get_dfu_devices() -> Generator[mock.Mock, None, None]:
    """Mock pyfu._get_dfu_devices."""
    with mock.patch("pyfu._get_dfu_devices") as mock_obj:
        yield mock_obj


@pytest.fixture()
def mock_get_dfu_desc() -> Generator[mock.Mock, None, None]:
    """Mock pyfu.descriptor.get_dfu_descriptor."""
    with mock.patch("pyfu.descriptor.get_dfu_descriptor") as mock_obj:
        yield mock_obj
...
def mock_dfu() -> Generator[mock.Mock, None, None]:
    """Mock pyfu.dfu."""
    with mock.patch("pyfu.dfu") as mock_obj:
        yield mock_obj
